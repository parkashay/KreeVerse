    ...
    <div className="w-full h-full">
      ...
      >
        <div className="flex items-center justify-start h-full max-w-[1536px] w-full px-4 md:px-10">
          ...
          <SfButton
            className="hidden md:flex text-white bg-transparent font-body hover:bg-primary-800 hover:text-text active:bg-primary-900 active:text-white"
            aria-haspopup="true"
            aria-expanded={isOpen}
          ...
          >
            <SfInput
              value={inputValue}
              type="search"
              className="[&::-webkit-search-cancel-button]:appearance-none border-none"
              placeholder="Search"
