...
export default function EditAddressCard({
  ...
  return (
    <>
            ...
            <div className="space-y-4 my-4">
              ...
              {deleteAddress.data && (
                <ErrorMessage
                  ...
                  message={
                    deleteAddress.data?.message ?? 'Something went wrong.'
                  }
                />
              )}
            </div>
      ...
      <div
        className={clsx(
          'border rounded-lg border-gray-200 p-5 min-h-[220px] h-full w-full flex flex-col justify-between gap-8 transition-colors',
          {
